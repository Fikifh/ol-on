 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('/admin') }}">OL-ON ADMIN AREA</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/admin/form/produk') }}"><i class="fa fa-plus-circle"></i> Tambah Barang</a>
                        </li>
                        <li {{ (Request::is('*charts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/admin') }}"><i class="fa fa-folder-open-o"></i> Lihat Produk</a>
                            <!-- /.nav-second-level -->
                        </li>                        
                    </ul>
                </div>
